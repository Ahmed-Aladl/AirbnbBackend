...
public class AmenityService
{
    ...
    public async Task<Result<bool>> Toggle(int amenityId, int propertyId)
    {
        ...
        var propAmenity = property?.PropertyAmenities?.FirstOrDefault(a => a.AmenityId == amenityId);
        if (propAmenity !=null)
        {
        ...
        propAmenity = new PropertyAmenity() { AmenityId= amenityId , PropertyId = propertyId};
