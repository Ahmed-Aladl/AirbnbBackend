...
namespace Application.Interfaces.Services
{
    ...
    {
        Task<Result<RespondToReservationRequestDto>> GetChatSessionForHostAsync(string hostId, string chatSessionId, string? targetLang = null);
        ...
        Task<Result<RespondToReservationRequestDto>> Reserve(int propertyId, string userId, CreateReservationRequestDto createReqeust, string? targetLang = null);
