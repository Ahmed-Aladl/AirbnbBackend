        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersOtp_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersOtp_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_calendarAvailabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_calendarAvailabilities_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyViolations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyViolations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyViolations_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishlistProperties", x => new { x.WishlistId, x.PropertyId });
                    table.ForeignKey(
                        name: "FK_WishlistProperties_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishlistProperties_Wishlists_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_calendarAvailabilities_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyViolations_PropertyId",
                table: "PropertyViolations",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyViolations_UserId",
                table: "PropertyViolations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersOtp_UserId1",
                table: "UsersOtp",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_WishlistProperties_PropertyId",
                table: "WishlistProperties",
                column: "PropertyId");
